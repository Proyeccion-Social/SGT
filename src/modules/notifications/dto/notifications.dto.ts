...
export class SessionScheduledDto {
  ...
  @IsEnum(SessionType, { message: 'sessionType debe ser INDIVIDUAL o COLLABORATIVE' })
...
export class SessionReminderDto {
  ...
  @IsEnum(ReminderType, { message: 'reminderType debe ser 24_HOURS_BEFORE o 2_HOURS_BEFORE' })
  ...
  @IsUUID('4', { each: true, message: 'Cada participantId debe ser UUID válido' })
