...
export class SessionService {
  ...
  async proposeModification(userId: string, sessionId: string, dto: ProposeModificationDto) {
    ...
    if (dto.newScheduledDate || dto.newAvailabilityId || dto.newDurationHours) {
      const newDate      = dto.newScheduledDate ? new Date(dto.newScheduledDate) : session.scheduledDate;
    ...
    modificationRequest.newScheduledDate = dto.newScheduledDate ? new Date(dto.newScheduledDate) : undefined;
