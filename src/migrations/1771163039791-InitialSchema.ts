...
export class InitialSchema1771163039791 implements MigrationInterface {
    name = 'InitialSchema1771163039791'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "questions" ("id_question" BIGSERIAL NOT NULL, "content" text NOT NULL, CONSTRAINT "PK_42f7d8f0cb5a36bdb8873474f73" PRIMARY KEY ("id_question"))`);
        await queryRunner.query(`CREATE TABLE "answers" ("id_question" bigint NOT NULL, "id_student" uuid NOT NULL, "id_session" bigint NOT NULL, "score" smallint, CONSTRAINT "PK_c1417fe520634f4cb323644d9f8" PRIMARY KEY ("id_question", "id_student", "id_session"))`);
        ...
        await queryRunner.query(`CREATE TABLE "student_participate_session" ("id_student" uuid NOT NULL, "id_session" bigint NOT NULL, "status" "public"."student_participate_session_status_enum", "comment" text, CONSTRAINT "PK_bd04f2a8d91eafd52dd6d937527" PRIMARY KEY ("id_student", "id_session"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sessions" ("id_session" BIGSERIAL NOT NULL, "id_tutor" uuid NOT NULL, "id_subject" uuid NOT NULL, "scheduled_date" date NOT NULL, "start_time" TIME NOT NULL, "end_time" TIME NOT NULL, "type" "public"."sessions_type_enum", "modality" "public"."sessions_modality_enum", "status" "public"."sessions_status_enum", "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_858bc8fe367b57b2de3ad3316bd" PRIMARY KEY ("id_session"))`);
        await queryRunner.query(`CREATE TABLE "scheduled_sessions" ("id_tutor" uuid NOT NULL, "id_availability" bigint NOT NULL, "id_session" bigint, CONSTRAINT "REL_6df0305f4681b7af345413ee6d" UNIQUE ("id_session"), CONSTRAINT "PK_01760f690a68a7095a22ff8475e" PRIMARY KEY ("id_tutor", "id_availability"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tutor_have_availability" ("id_tutor" uuid NOT NULL, "id_availability" bigint NOT NULL, "modality" "public"."tutor_have_availability_modality_enum", CONSTRAINT "PK_1081a75d607ac74f1c1daac8e70" PRIMARY KEY ("id_tutor", "id_availability"))`);
        await queryRunner.query(`CREATE TABLE "tutors" ("id_user" uuid NOT NULL, "phone" character varying(20), "isActive" boolean NOT NULL DEFAULT true, "limit_disponibility" smallint, "profile_completed" boolean NOT NULL DEFAULT false, "url_image" text, CONSTRAINT "PK_8325796beb64a4c91dfe1c3955b" PRIMARY KEY ("id_user"))`);
        ...
        await queryRunner.query(`CREATE TABLE "subjects" ("id_subject" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "code" character varying(20), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_47a287fe64bd0e1027e603c335c" UNIQUE ("name"), CONSTRAINT "UQ_542cbba74dde3c82ab49c573109" UNIQUE ("code"), CONSTRAINT "PK_9fd9ccf52e70e96b69499c3be50" PRIMARY KEY ("id_subject"))`);
        ...
        await queryRunner.query(`ALTER TABLE "students" ADD "id_user" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "students" ADD CONSTRAINT "PK_b559710a42d2bf3b49062750132" PRIMARY KEY ("id_user")`);
        await queryRunner.query(`ALTER TABLE "students" ADD "career" character varying(100)`);
        await queryRunner.query(`CREATE TYPE "public"."students_preferred_modality_enum" AS ENUM('PRES', 'VIRT')`);
        await queryRunner.query(`ALTER TABLE "students" ADD "preferred_modality" "public"."students_preferred_modality_enum"`);
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_412317c2f4613f7f852ec0eaf31" FOREIGN KEY ("id_subject") REFERENCES "subjects"("id_subject") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "tutor_impart_subject" ADD CONSTRAINT "FK_e2a77eea1cf449be7efe7147b31" FOREIGN KEY ("id_subject") REFERENCES "subjects"("id_subject") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "student_interested_subject" ADD CONSTRAINT "FK_36ba92aa42c5d6d14eca4ac8028" FOREIGN KEY ("id_subject") REFERENCES "subjects"("id_subject") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "students" DROP COLUMN "preferred_modality"`);
        await queryRunner.query(`DROP TYPE "public"."students_preferred_modality_enum"`);
        await queryRunner.query(`ALTER TABLE "students" DROP COLUMN "career"`);
        await queryRunner.query(`ALTER TABLE "students" DROP CONSTRAINT "PK_b559710a42d2bf3b49062750132"`);
        await queryRunner.query(`ALTER TABLE "students" DROP COLUMN "id_user"`);
        await queryRunner.query(`ALTER TABLE "students" ADD "email" "char" NOT NULL`);
